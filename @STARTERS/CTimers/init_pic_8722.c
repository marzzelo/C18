//+--------------------------------------------------------------------------+
//|       $Workfile:: init_pic_8722.c            $ $Revision:: 12            $
//+--------------------------------------------------------------------------+
//|         $Author:: valdez                                                 $
//|        $Modtime:: 20/08/13 7:57                                          $
//|        $Archive:: /@C18/@STARTERS/CTimers/init_pic_8722.c                $
//+--------------------------------------------------------------------------+
/*
...
/*				 	 _                                
	...
	// INTCON = PEIE_ON | TMR0IE_ON | GIE_OFF;  // GIE_OFF --> Activar en main, luego de los
											 // constructores
...
/*
	...
	INTCON  = PEIE_ON | TMR0IE_ON | GIE_OFF; 
	INTCON2 = 0x00; 
	INTCON3 = 0x00; 
}//
