...
QSCtr QS_end_ = 0;                      /* offset of the end of the ring buffer */
QSCtr QS_head_ = 0;             /* offset to where next byte will be inserted */
QSCtr QS_tail_ = 0;              /* offset of where next byte will be extracted */
QSCtr QS_used_ = 0;             /* number of bytes currently in the ring buffer */
uint8_t QS_seq_ = 0;                              /* the record sequence number */
uint8_t QS_chksum_ = 0;                   /* the checksum of the current record */
uint8_t QS_full_ = 0;                    /* the ring buffer is temporarily full */
