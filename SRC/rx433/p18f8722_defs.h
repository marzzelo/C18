//;+------------------------------------------------------------------+
//;|       $Workfile:: p18f8722_defs.h            $ $Revision:: 10    $
//;+------------------------------------------------------------------+
//;|         $Author:: valdez                                         $
//;|        $Modtime:: 23/12/13 12:56                                 $
//;|        $Archive:: /@C18/SRC/rx433/p18f8722_defs.h                $
//;+------------------------------------------------------------------+

/*
				http://www.network-science.de/ascii/  font: rounded/small/standard
...
//1 = High priority
//0 = Low priority
#define PSPIP_HI	0b10000000
#define PSPIP_LO	0x00

//bit 6 ADIP: A/D Converter Interrupt Priority bit
//1 = High priority
//0 = Low priority
#define ADIP_HI	0b01000000
#define ADIP_LO	0x00

//bit 5 RC1IP: EUSART1 Receive Interrupt Priority bit
//1 = High priority
//0 = Low priority
#define RC1IP_HI	0b00100000
#define RC1IP_LO	0x00

//bit 4 TX1IP: EUSART1 Transmit Interrupt Priority bit
//1 = High priority
//0 = Low priority
#define TX1IP_HI	0b00010000
#define TX1IP_LO	0x00

//bit 3 SSP1IP: MSSP1 Interrupt Priority bit
//1 = High priority
//0 = Low priority
#define SSP1IP_HI	0b00001000
#define SSP1IP_LO	0x00

//bit 2 CCP1IP: ECCP1 Interrupt Priority bit
//1 = High priority
//0 = Low priority
#define CCP1IP_HI	0b00000100
#define CCP1IP_LO	0x00

//bit 1 TMR2IP: TMR2 to PR2 Match Interrupt Priority bit
//1 = High priority
//0 = Low priority
#define TMR2IP_HI	0b00000010
#define TMR2IP_LO	0x00

//bit 0 TMR1IP: TMR1 Overflow Interrupt Priority bit
//1 = High priority
//0 = Low priority			
#define TMR1IP_HI	0b00000001
#define TMR1IP_LO	0x00
...
//1 = High priority
//0 = Low priority
#define OSCFIP_HI	0b10000000
#define OSCFIP_LO	0x00

//bit 6 CMIP: Comparator Interrupt Priority bit
//1 = High priority
//0 = Low priority
#define CMIP_HI		0b01000000
#define CMIP_LO		0x00
...
//1 = High priority
//0 = Low priority
#define EEIP_HI		0b00010000
#define EEIP_LO		0x00

//bit 3 BCL1IP: MSSP1 Bus Collision Interrupt Priority bit
//1 = High priority
//0 = Low priority
#define BCL1IP_HI	0b00001000
#define BCL1IP_LO	0x00

//bit 2 HLVDIP: High/Low-Voltage Detect Interrupt Priority bit
//1 = High priority
//0 = Low priority
#define HLVDIP_HI	0b00000100
#define HLVDIP_LO	0x00

//bit 1 TMR3IP: TMR3 Overflow Interrupt Priority bit
//1 = High priority
//0 = Low priority
#define TMR3IP_HI	0b00000010
#define TMR3IP_LO	0x00

//bit 0 CCP2IP: ECCP2 Interrupt Priority bit
//1 = High priority
//0 = Low priority
#define CCP2IP_HI	0b00000001
#define CCP2IP_LO	0x00
...
//1 = High priority
//0 = Low priority
#define SSP2IP_HI	0b10000000
#define SSP2IP_LO	0x00

//bit 6 BCL2IP: MSSP2 Bus Collision Interrupt Priority bit
//1 = High priority
//0 = Low priority
#define BCL2IP_HI	0b01000000
#define BCL2IP_LO	0x00

//bit 5 RC2IP: EUSART2 Receive Interrupt Priority bit
//1 = High priority
//0 = Low priority
#define RC2IP_HI	0b00100000
#define RC2IP_LO	0x00

//bit 4 TX2IP: EUSART2 Transmit Interrupt Priority bit
//1 = High priority
//0 = Low priority
#define TX2IP_HI	0b00010000
#define XT2IP_LO	0x00

//bit 3 TMR4IP: TMR4 to PR4 Match Interrupt Priority bit
//1 = High priority
//0 = Low priority
#define TMR4IP_HI	0b00001000
#define TMR4IP_LO	0x00

//bit 2 CCP5IP: CCP5 Interrupt Priority bit
//1 = High priority
//0 = Low priority
#define CCP5IP_HI	0b00000100
#define CCP5IP_LO	0x00

//bit 1 CCP4IP: CCP4 Interrupt Priority bit
//1 = High priority
//0 = Low priority
#define CCP4IP_HI	0b00000010
#define CCP4IP_LO	0x00

//bit 0 CCP3IP: ECCP3 Interrupt Priority bit
//1 = High priority
//0 = Low priority
#define CCP3IP_HI	0b00000001
#define CCP3IP_LO	0x00
