//+--------------------------------------------------------------------------+
//|       $Workfile:: init_pic_8722.c            $ $Revision:: 16            $
//+--------------------------------------------------------------------------+
//|         $Author:: valdez                                                 $
//|        $Modtime:: 23/12/13 12:58                                         $
//|        $Archive:: /@C18/SRC/rx433/init_pic_8722.c                        $
//+--------------------------------------------------------------------------+
/*
...
// 	VER io_cfg.h !!!
	...
	PORTB = 0x00;
	TRISB = 0b11101111;  //ATN!: RB0 conectado a SW1, no tocar.
	
	PORTC = 0x00;
	TRISC = 0b11010011; // bit2: BUZZ
	
	PORTD = 0x00;
	TRISD = 0b00000000;

	PORTE = 0x00;
	TRISE = 0b00000000; 	// RE7:RE4 --> LEDS INDICADORES
...
/*
	...
	INTCON  = PEIE_ON | TMR0IE_ON | GIE_ON | GIEL_ON; 
	INTCON2 = TMR0IP_LO; // DEFAULT = ALL IP_LO
	INTCON3 = 0x00; 
	IPR1 = TMR1IP_HI;
}//
