//+--------------------------------------------------------------------------+
//|  $Workfile:: Relay.c                           $ $Revision:: 10          $
//+--------------------------------------------------------------------------+
//|  $Author:: valdez                                                        $
//|  $Modtime:: 23/09/13 14:44                                               $
...
void Relay_ustart(Relay *me,
					...
					uint16_t cycles, 
					uint16_t inicnt, 
					uint16_t coffset) // custom start
{
	ASSERT(Ton > 0); 	/* ERROR: se ha instanciado el objeto? */
	ASSERT(Toff > 0);	/* ERROR: se ha instanciado el objeto? */
