//;+--------------------------------------------------------------------------+
//;|       $Workfile:: io_cfg.h                   $ $Revision:: 14            $
//;+--------------------------------------------------------------------------+
//;|         $Author:: valdez                                                 $
//;|        $Modtime:: 23/12/13 10:27                                         $
//;|        $Archive:: /@C18/SRC/rx433/io_cfg.h                               $
//;+--------------------------------------------------------------------------+
//;|      Module Type:                                                        $
//;|      Description:                                                        $
//;+--------------------------------------------------------------------------+
...
#define		AFREE4		PORTAbits.RA4	///<i Feedback bumper
#define		SW2			PORTAbits.RA5	///<i Tact Switch S2
#define		AFREE6		PORTAbits.RA6	///<i
#define		RXPIN		PORTAbits.RA7	///<i Rx 433
...
#define		SW3			PORTBbits.RB3	///<i 
#define		nBUZZ		PORTBbits.RB4	///<i 
...
#define		BUZZ		PORTCbits.RC2	///<o BUZZER
...
#define		LED_IDLE	PORTEbits.RE4	///< 
#define		LED_PAUS	PORTEbits.RE5	///< 
#define		LED_RUNN	PORTEbits.RE6	///< 
#define		LED_CONF	PORTEbits.RE7	///< 
