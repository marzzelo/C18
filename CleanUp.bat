rem $History: CleanUp.bat $
rem 
rem *****************  Version 7  *****************
rem User: Marcelo      Date: 13/02/09   Time: 15:10
rem Updated in $/@CODE
rem 
rem *****************  Version 3  *****************
rem User: Marcelo      Date: 9/11/07    Time: 11:26a
rem Updated in $/C18
rem - Se agrega *.mptags y *.tagsrc
rem 
rem *****************  Version 2  *****************
rem User: Marcelo      Date: 9/11/07    Time: 10:37a
rem Updated in $/C18
rem - Se agrega *.mcs
@echo off
